...
class ColumnOperators(Operators):
    ...
    def regexp_replace(self, pattern: Any, replacement: Any, flags: Optional[str]=None) -> ColumnOperators:
        ...
        E.g.::
            ...
            stmt = select(
                table.c.some_column.regexp_replace("b(..)", "X\x01Y", flags="g")
            )
...
def is_precedent(operator: OperatorType, against: Optional[OperatorType]) -> bool:
    if operator is against and is_natural_self_precedent(operator):
        ...
        return bool(_PRECEDENCE.get(operator, getattr(operator, 'precedence', _OpLimit._smallest)) <= _PRECEDENCE.get(against, getattr(against, 'precedence', _OpLimit._largest)))
...
op_methods: Final = {'+': '__add__', '-': '__sub__', '*': '__mul__', '/': '__truediv__', '%': '__mod__', 'divmod': '__divmod__', '//': '__floordiv__', '**': '__pow__', '@': '__matmul__', '&': '__and__', '|': '__or__', '^': '__xor__', '<<': '__lshift__', '>>': '__rshift__', '==': '__eq__', '!=': '__ne__', '<': '__lt__', '>=': '__ge__', '>': '__gt__', '<=': '__le__', 'in': '__contains__'}
...
reverse_op_methods: Final = {'__add__': '__radd__', '__sub__': '__rsub__', '__mul__': '__rmul__', '__truediv__': '__rtruediv__', '__mod__': '__rmod__', '__divmod__': '__rdivmod__', '__floordiv__': '__rfloordiv__', '__pow__': '__rpow__', '__matmul__': '__rmatmul__', '__and__': '__rand__', '__or__': '__ror__', '__xor__': '__rxor__', '__lshift__': '__rlshift__', '__rshift__': '__rrshift__', '__eq__': '__eq__', '__ne__': '__ne__', '__lt__': '__gt__', '__ge__': '__le__', '__gt__': '__lt__', '__le__': '__ge__'}
reverse_op_method_names: Final = set(reverse_op_methods.values())
op_methods_that_shortcut: Final = {'__add__', '__sub__', '__mul__', '__truediv__', '__mod__', '__divmod__', '__floordiv__', '__pow__', '__matmul__', '__and__', '__or__', '__xor__', '__lshift__', '__rshift__'}
...
int_op_to_method: Final = {'==': int.__eq__, 'is': int.__eq__, '<': int.__lt__, '<=': int.__le__, '!=': int.__ne__, 'is not': int.__ne__, '>': int.__gt__, '>=': int.__ge__}
flip_ops: Final = {'<': '>', '<=': '>=', '>': '<', '>=': '<='}
neg_ops: Final = {'==': '!=', '!=': '==', 'is': 'is not', 'is not': 'is', '<': '>=', '<=': '>', '>': '<=', '>=': '<'}